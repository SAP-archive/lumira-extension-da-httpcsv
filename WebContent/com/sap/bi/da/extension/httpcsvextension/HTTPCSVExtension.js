...
define(["service!sap.bi.da.extension.sdk.clientRequestService", "HTTPCSVExtensionDialogController"], function (ClientRequestService, HTTPCSVExtensionDialogController) {
    "use strict";

    function HTTPCSVExtension() {

        var EXTENSION_ID = "com.sap.bi.da.extension.httpcsvextension";
        ...
        var createHTTPCSVExtensionDialog = function(acquisitionState, workflow) {
            var oDeferred = new jQuery.Deferred();
            var controller = new HTTPCSVExtensionDialogController(acquisitionState, oDeferred, fServiceCall, workflow);
        ...
        this.doCreateWorkflow = function(acquisitionState) {
            return createHTTPCSVExtensionDialog(acquisitionState, "CREATE");
        };

    	// This function will be called during an edit dataset workflow
        this.doEditWorkflow = function(acquisitionState) {
            return createHTTPCSVExtensionDialog(acquisitionState, "EDIT");
        };
    ...
    HTTPCSVExtension.prototype.getConnectionDescription = function(acquisitionState) {
    ...
    HTTPCSVExtension.prototype.getIcon48 = function() {
        return "/img/48.png";
    };
    HTTPCSVExtension.prototype.getIcon32 = function() {
        return "/img/32.png";
    };
    // The white version of the icon will be displayed when the extension is highlighted in the New Dataset dialog
    HTTPCSVExtension.prototype.getIcon32_white = function() {
        return "/img/32_w.png";
    };
    HTTPCSVExtension.prototype.getIcon24 = function() {
        return "/img/24.png";
    };
    HTTPCSVExtension.prototype.getIcon16 = function() {
        return "/img/16.png";
    };

    return HTTPCSVExtension;
});